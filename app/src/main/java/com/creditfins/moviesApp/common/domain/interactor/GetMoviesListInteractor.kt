...
class GetMoviesListInteractor(private val mCommonRepository: CommonRepository): Interactor<Int, Flow<Movie>> {
    override fun execute(params: Int): Flow<Movie> = mCommonRepository.getMoviesList(params)
}